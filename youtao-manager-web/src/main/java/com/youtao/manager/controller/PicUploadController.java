...
import com.youtao.common.bean.PicUploadResult;
import com.youtao.manager.service.PropertieService;
...
public class PicUploadController {
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile) throws Exception {
		...
		// 生成图片的绝对引用地址
		String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, propertieService.repositoryPath), "\\", "/");
		fileUploadResult.setUrl(propertieService.imageBaseUrl + picUrl);
...
//		response.setContentType(MediaType.TEXT_HTML_VALUE);
	...
	private String getFilePath(String sourceFileName) {
		String baseFolder = propertieService.repositoryPath + File.separator + "images";
