...
var YT = YOUTAO = {
    ...
    initPicUpload: function (data) {
        $(".picFileUpload").each(function (i, e) {
            ...
            $(e).click(function () {
                ...
                KindEditor.editor(YT.kingEditorParams).loadPlugin('multiimage', function () {
                    var editor = this;
    ...
    createEditor: function (select) {
        return KindEditor.create(select, YT.kingEditorParams);
    },
    ...
    changeItemParam: function (node, formId) {
    	$.ajax({
			...
			statusCode: {
				...
				500: function() {
					$.messager.alert("提示", "查询类目模板失败，请稍后再试!");
				}
			}
		});
...
//        });
    ...
    initOnePicUpload: function () {
        $(".onePicUpload").click(function () {
            var _self = $(this);
            KindEditor.editor(YT.kingEditorParams).loadPlugin('image', function () {
